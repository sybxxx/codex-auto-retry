...
| `scripts/tray-smoke-test.ps1` | Starts an isolated watchdog, verifies its native tray window, visible settings form, settings-process shutdown, heartbeat, and clean status shutdown. |
